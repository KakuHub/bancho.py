...
DISCORD_SCORES_LOG_WEBHOOK = os.environ["DISCORD_SCORES_LOG_WEBHOOK"]
DISCORD_MAPS_LOG_WEBHOOK = os.environ["DISCORD_MAPS_LOG_WEBHOOK"]
DISCORD_REQ_LOG_WEBHOOK = os.environ["DISCORD_REQ_LOG_WEBHOOK"]
